...
public class UDP_updateFine {
	...
	Connection connect = null;
	    ...
	    byte[] sendbid = new byte[1024];
	     ...
	     public UDP_updateFine(String uid,String bookname,String check) throws UnknownHostException, SocketException, IOException{
	         //bookid
	   	  IPAddress = InetAddress.getByName("localhost");
	         clientSocketbid = new DatagramSocket();
	         sendbid = uid.getBytes();
